                        ...
                        <div class="card-body">
                            ...
                            <ul class="card-text list-group">
                                <?php for($i = 0; $i <= $count-1; $i++){ ?>
                                        <a href="inventario.php?empID=<?php echo $lista[$i][0]; ?>" class="link-success"><li class="list-group-item"><?php echo $lista[$i][1]; ?></li></a>
                                <?php } ?>
                            </ul>
                        </div>
                </div>
                        ...
                        <h2>Modificar mis datos:</h2>
                            <form class="form" action="db/actualizarCorreo.php" method="POST">
                                ...
                                <div class="form-group input-group">
                                    ...
                                    <div class="col-xs-4">
                                        <input name="correoNuevo" class="form-control" placeholder="Correo electrónico" type="email" value = "<?php echo $_POST['correo'];?>" required>
                                    </div>
                                </div>
                                </label>
                                <div class="form-group">
                                    <br><button type="submit" class="btn btn-primary btn-sm"> Cambiar email  </button>
                                </div>
                            </form><br>
                        </div>
                        <div class="container-sm">
                            <form class="form" action="db/actualizarContra.php" method="POST">                     
                                ...
                                <div class="form-group input-group">
                                    ...
                                    <div class="col-xs-4">
                                        <input name="contrasenaNueva" class="form-control" placeholder="Nueva contraseña" type="password" required><br>
                                    </div>
                                </div>
                                <div class="form-group input-group col-xs-3">
                                    ...
                                    <div class="col-xs-4">
                                        <input class="form-control" name="contrasena2Nueva" placeholder="Repetir contraseña" type="password" required>
                                    </div>
                                </div>                                     
                                <div class="form-group">
                                    <br><button type="submit" class="btn btn-primary btn-sm"> Cambiar contraseña  </button>
                                </div>
                                </label>    
                            </form>
                        </div>
