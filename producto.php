...
<html>
    ...
    <body>
        ...
        <main>
            <div class="container">
                <h2>Editando producto: <center><?php echo $lista[0][0]; ?></center></h2>
                <form action="db/editarProducto.php" class="form" method="POST" enctype="multipart/form-data">
                    <div class="form-group input-group">    
                        <label for="codigo">Codigo:<br>
                        <input type="text" class="form-control" name="codigo" value="<?php echo $codProd; ?>" id="codigo" placeholder="codigo del producto" required>
                        </label>
                    </div>
                    <div class="form-group input-group">    
                        <label for="nombre">Nombre:<br>
                        <input type="text" class="form-control" name="nombre" value="<?php echo $lista[0][0]; ?>" id="nombre" placeholder="Nombre del producto" required>
                        </label>
                    </div>
                    <div class="form-group input-group">    
                        <label for="precio">Precio:<br>
                        <input type="number" class="form-control" name="precio" value="<?php echo $lista[0][1]; ?>" id="precio" placeholder="Precio del Producto" required>
                        </label>
                    </div>
                    <div class="form-group input-group">
                        <label for="cantidad">Cantidad:<br>
                        <input type="number" class="form-control" name="cantidad" value="<?php echo $lista[0][2]; ?>" id="cantidad" placeholder="Cantidad de producto" required>
                        </label>
                    </div>
                    <div class="form-group input-group">
                ...
                <a href="db/editarProducto.php?del=<?php echo $codProd;?>&empID=<?php echo $rutEmpresa?>"><button type="submit" class="btn btn-danger"> ELIMINAR PRODUCTO </button></a>               
            </div>                  
        </main>
